...
public class FileUploadController {
	...
	public String saveWebpage(@Valid webInfo webInfo, BindingResult result, ModelMap model) {
		webInfoService.saveWebpage(webInfo);
		return "redirect:/admin";
	}

	@RequestMapping(value = { "/new-user" }, method = RequestMethod.GET)
	public String registrationUser( ModelMap model) {
		User user = new User();
	...
	public String saveUser(@Valid User user, BindingResult result, ModelMap model) {
		//webInfoService.saveWebpage(user);
	...
	public String page403(Model model) throws IOException {
		return "jsp/403";
	}
	...
	public String updateUser(@Valid webInfo webInfo, ModelMap model, @PathVariable int pageID) {
	 ...
	 * searchFiles(@RequestParam("fileName") String name, Model model) throws
	 * IOException {
	 * model.addAttribute("result",fileSearchService.searchFile(name)); return
	 * "uploadForm"; }
	 */
